...
#define STRING_CONFIG_H_AUTHOR "(ShinyUpgrades.com)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ShinyUpgrades.com E3P"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
    ...
    // Ender 3 v2
        ...
        #define DEFAULT_Kp_LIST {  15.60,  15.60 }
        #define DEFAULT_Ki_LIST {   1.40,   1.40 }
        #define DEFAULT_Kd_LIST { 43.30, 43.30 }
    #else
...
#define PIDTEMPBED
    ...
    #define DEFAULT_bedKp 163.3
    #define DEFAULT_bedKi 28.34
    #define DEFAULT_bedKd 626.9
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, -45.0, -2.62 }
